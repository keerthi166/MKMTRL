function [K,option]=constructKernel(x,kernel,kerneloption,xsup,framematrix,vector,dual)

% Usage  K=constructKernel(x,kernel,kerneloption,xsup,frame,vector,dual);
%
